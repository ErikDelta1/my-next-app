...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white p-6 md:p-12">
      <h1 className="text-4xl font-extrabold text-center mb-12">Porovnání automobilů</h1>

      <div className="flex flex-col md:flex-row justify-center items-start gap-12 mb-12">
        <div className="w-full md:w-1/3">
          <h2 className="text-2xl font-semibold mb-4">Auto 1</h2>
          <CarSelector onSelect={handleSelectCar1} />
        </div>
        <div className="w-full md:w-1/3">
          <h2 className="text-2xl font-semibold mb-4">Auto 2</h2>
          <CarSelector onSelect={handleSelectCar2} />
        </div>
      </div>

      {loading && <p className="text-center text-blue-400">Načítání dat...</p>}
